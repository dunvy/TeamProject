...
//     int S_atk;
// };
// struct devMon enemyDevmon, myDevMon1, myDevMon2, myDevMon3;
...
// //도구 이용할 개발몬 보여줌
// void itemMon(int bool)      //bool값이 1이면 hp, 0이면 mp
// {
//     if(myDevMon3.level!=0){
//         printf("1. %s: %s:%d/%d ", myDevMon1.name, (bool ? "HP":"MP"), (bool ? myDevMon1.hp:myDevMon1.mp), (bool ? myDevMon1.max_hp:myDevMon1.max_mp));
//         printf("2. %s: %s:%d/%d ", myDevMon2.name, (bool ? "HP":"MP"), (bool ? myDevMon2.hp:myDevMon2.mp), (bool ? myDevMon2.max_hp:myDevMon2.max_mp));
//         printf("3. %s: %s:%d/%d ", myDevMon3.name, (bool ? "HP":"MP"), (bool ? myDevMon3.hp:myDevMon3.mp), (bool ? myDevMon3.max_hp:myDevMon3.max_mp));
//     }
//     else if(myDevMon2.level!=0&&myDevMon3.level==0){
//         printf("1. %s: %s:%d/%d ", myDevMon1.name, (bool ? "HP":"MP"), (bool ? myDevMon1.hp:myDevMon1.mp), (bool ? myDevMon1.max_hp:myDevMon1.max_mp));
//         printf("2. %s: %s:%d/%d ", myDevMon2.name, (bool ? "HP":"MP"), (bool ? myDevMon2.hp:myDevMon2.mp), (bool ? myDevMon2.max_hp:myDevMon2.max_mp));
//     }
//     else if(myDevMon2.level==0&&myDevMon3.level==0){
...
// void MapItem(){
//     system("clear");
//     int item, devmon;               //item: 어떤 도구, devmon: 어떤 캐릭터
...
//             itemMon(1);
//             while(1){
//                 printf("어떤 개발몬에게 사용하시겠습니까?\n");
//                 scanf("%d", &devmon);

//                 if (devmon == 1)
//                 {
//                     printf("\"상처약\"을 사용했습니다. %s의 체력이 10%% 회복됩니다.\n", myDevMon1.name);
//                     potion.hpRecovery = myDevMon1.max_hp*0.1;
//                     potion.amount--;
//                     myDevMon1.hp += potion.hpRecovery;
//                     break;
//                 }
//                 else if (devmon == 2)
//                 {
//                     if (myDevMon2.level==0){                                    //2번 개발몬이 없으면 다시 선택
//                         printf("잘못된 선택입니다. 다시 선택해주세요!!! \n\n");
//                         continue;
//                     }
//                     else{
//                         printf("\"상처약\"을 사용했습니다. %s의 체력이 10%% 회복됩니다.\n", myDevMon2.name);
//                         potion.hpRecovery = myDevMon2.max_hp*0.1;
//                         potion.amount--;
//                         myDevMon2.hp += potion.hpRecovery;
//                         break;
//                     }
//                 }
//                 else if (devmon == 3)
//                 {
//                     if (myDevMon3.level==0){                                    //3번 개발몬이 없으면 다시 선택
//                         printf("잘못된 선택입니다. 다시 선택해주세요!!! \n\n");
//                         continue;
//                     }
//                     else{
//                         printf("\"상처약\"을 사용했습니다. %s의 체력이 10%% 회복됩니다.\n", myDevMon3.name);
//                         potion.hpRecovery = myDevMon3.max_hp*0.1;
//                         potion.amount--;
//                         myDevMon3.hp += potion.hpRecovery;
//                         break;
//                     }
//                 }
//                 else{
...
//             superPotion.amount--;
//             // superPotion.hpRecovery = myDevMon1.max_hp*0.2;              //좋은 상처약: 전체 체력의 20퍼 회복
//             myDevMon1.hp += superPotion.hpRecovery;
//         }
//         break; 
//     case 3:
...
//             hyperPotion.amount--;
//             // hyperPotion.hpRecovery = myDevMon1.max_hp*0.3;                   //고급 상처약: 전체 체력의 30퍼 회복
//             myDevMon1.hp += hyperPotion.hpRecovery;
//         }
//         break; 
//     case 4:
...
//             maxPotion.amount--;
//             maxPotion.hpRecovery = myDevMon1.max_hp-myDevMon1.hp;      
//             // maxPotion.hpRecovery = myDevMon1.max_hp-myDevMon1.hp;       //풀 회복약: 풀피
//             // myDevMon1.hp += maxPotion.hpRecovery;
...
//             mpPotion.amount--;
//             // mpPotion.mpRecovery = myDevMon1.max_mp * 0.2;               //mp 회복약: mp 20퍼 회복
//             myDevMon1.mp += mpPotion.mpRecovery;
//         }
//         break; 
//     case 6:
//         if (mysteryPotion.amount == 0)
//             printf("보유 중인 \"공격용 물약\"이 없습니다!\n");            
//         else{
//             printf("\"공격용 물약\"을 사용했습니다!\n");
//             sleep(1);
//             printf("... 놀라울 정도로 아무 일도 일어나지 않았다!\n");
//             mysteryPotion.amount--;
//             break;
//         }
//     case 7:
...
// // void useItem(struct pocket use){
// //     use.amount--;
// //     use.hpRecovery = 0.1;
// // }

// // void useItem(struct pocket use){
// //     printf("상처약을 사용했습니다. 체력이 10%% 회복됩니다.\n");
// //     use.amount--;
// //     use.hpRecovery = 0.1;
// //     if (myDevMon1.hp)
// //     {
...
// void printDevmon(){
//     if(myDevMon3.level!=0){
//         printf("Lv:%d %s: HP:%d/%d MP:%d/%d\n",myDevMon1.level,myDevMon1.name,myDevMon1.hp,myDevMon1.max_hp,myDevMon1.mp,myDevMon1.max_mp);
//         printf("Lv:%d %s: HP:%d/%d MP:%d/%d\n",myDevMon2.level,myDevMon2.name,myDevMon2.hp,myDevMon2.max_hp,myDevMon2.mp,myDevMon2.max_mp);
//         printf("Lv:%d %s: HP:%d/%d MP:%d/%d\n",myDevMon3.level,myDevMon3.name,myDevMon3.hp,myDevMon3.max_hp,myDevMon3.mp,myDevMon3.max_mp);
//     }
//     else if(myDevMon2.level!=0&&myDevMon3.level==0){
//         printf("Lv:%d %s: HP:%d/%d MP:%d/%d\n",myDevMon1.level,myDevMon1.name,myDevMon1.hp,myDevMon1.max_hp,myDevMon1.mp,myDevMon1.max_mp);
//         printf("Lv:%d %s: HP:%d/%d MP:%d/%d\n",myDevMon2.level,myDevMon2.name,myDevMon2.hp,myDevMon2.max_hp,myDevMon2.mp,myDevMon2.max_mp);
