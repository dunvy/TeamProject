...
void quiz(){
    ...
    char* a[10] = {
        ...
        "얼룩말의 줄무늬는 하얀색이다.\n",
        "새우깡 봉지 앞면에는 새우가 한 개 그려져 있다.\n",
        "채찍이라는 듯을 가진 '람바다'는 브라질 춤이다.\n",
        "사람의 신체 부위 중 주름이 가장 많은 곳은 입술이다.\n",
        "한국에 커피가 소개된 것은 고종 때부터이다.\n",
        "개구리는 배꼽이 없다.\n"
    };
    ...
    char* b[10] = {
        ...
        "날개를 가진 새 중 가장 빠른 새는 독수리이다.\n",
        "미식 축구의 경기 인원은 10명이다.\n",
        "파리가 앞발을 서로 부비는 것은 먹이를 찾는 행동이다.\n",
        "기린의 울음소리는 말과 흡사하다.\n",
        "구기 종목 중 가장 작은 공을 사용하는 경기는 골프다.\n"
    };
